    ...
    BootstrapDialogModal.METHODS_TO_OVERRIDE['v3.3'] = {
        ...
        hideModal: function() {
            ...
            this.backdrop($.proxy(function() {
                var openModal=$("div[role='dialog'][aria-hidden=false]");//所有已显示的模态窗口
                var openedDialogs = this.getGlobalOpenedDialogs();//所有已显示的Dialog
                if (openedDialogs.length === 0&&openModal.length===0) {
                    this.$body.removeClass('modal-open');
                }
                //this.resetAdjustments();/*注掉，异常报错*/
                this.resetScrollbar();
